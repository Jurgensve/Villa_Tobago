                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <?php if (!empty($removed_pets)): ?>
                            <div class="md:col-span-2 mt-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                                <label class="block text-gray-700 text-sm font-bold mb-1">Is this pet replacing a previously
                                    removed pet?</label>
                                <p class="text-xs text-gray-500 mb-3">If yes, select the pet it is replacing below. This helps
                                    the Trustees track replacements.</p>
                                <select name="replacement_for_pet_id"
                                    class="w-full border-2 border-gray-200 rounded-lg px-4 py-2.5 focus:border-yellow-400 outline-none transition bg-white"
                                    onchange="showRemovalReason(this)">
                                ...
                                <div id="replacement_reason_box"
                                    class="hidden mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-800">
