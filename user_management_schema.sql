...
ALTER TABLE users
    ...
    ADD COLUMN IF NOT EXISTS role       ENUM('admin','managing_agent','trustee') NOT NULL DEFAULT 'managing_agent' AFTER phone,
...
-- 2. Promote the earliest user to admin (the original setup user)
