...
ALTER TABLE owners
    ...
    ADD COLUMN IF NOT EXISTS second_resident_name    VARCHAR(100) DEFAULT NULL,
    ADD COLUMN IF NOT EXISTS second_resident_phone   VARCHAR(30)  DEFAULT NULL,
    ADD COLUMN IF NOT EXISTS second_resident_email   VARCHAR(100) DEFAULT NULL,
